...
{
    [SerializeField] GameObject[] pirateBalloons;
    ...
    public void Spawn()
    {
        ...
        GameObject pirateBalloon = Instantiate(pirateBalloons[Random.Range(0, pirateBalloons.Length)], spawnPos, Quaternion.identity);
    }
